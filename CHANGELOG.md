...
- fe9f6fa: Add Claude Opus 5.5 to the model catalog, including a high-effort thinking
  variant (Claude Opus 5.5 – High). Priced at $4/$20 per 1M input/output tokens
  for the local cost estimate.

## 0.6.0

### Minor Changes

- dbd4ba4: Add **Gemini 3.8 Flash** to the built-in model catalog, served by Vertex /
...
- 300969f: Fix parallel tool calls being reported to Claude as failures. VS Code delivers
...
- ef4c7bd: Fix a second cause of the Anthropic tool-pairing 400 ("tool_use ids were found
